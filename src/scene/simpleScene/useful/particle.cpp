...
//------------------------------------------------------------
void particle::addRepulsionForce(ofxVec3f posFrc, float radius, float scale){
	
	
	// ----------- (2) calculate the difference & length 
	
	ofxVec3f diff	= pos - posFrc;
...
void particle::addAttractionForce(ofxVec3f posFrc, float radius, float scale){
...
void particle::update(){	
	...
	float diffTime = timeNow - lastUpdateTime;
	lastUpdateTime = timeNow;
	
	
	
	float rate = 1.0; // MAX(2 * (1.0 / 0.02) * diffTime, 1.0);
