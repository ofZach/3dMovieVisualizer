...
void ofxCreateLineBoxList(){
	if(!(bool)glIsEnabled(GL_NORMALIZE)) glEnable(GL_NORMALIZE);
	lineBoxList = glGenLists(1);
	glNewList(lineBoxList, GL_COMPILE);
...
void ofxLineBox(float x, float y, float z, float size){
	if(lineBoxList == 0) ofxCreateLineBoxList();
	glPushMatrix();
	glTranslatef(x, y, z);
	glScalef(size, size, size);
	glCallList(lineBoxList);
	glPopMatrix();
}
void ofxLineBox(float x, float y, float z, float width, float height, float depth){
	if(lineBoxList == 0) ofxCreateLineBoxList();
	glPushMatrix();
	glTranslatef(x, y, z);
	glScalef(width, height, depth);
...
void ofxLineBox(float x, float y, float z, float width, float height, float depth, float rotX, float rotY, float rotZ){
	if(lineBoxList == 0) ofxCreateLineBoxList();
	glPushMatrix();
	glTranslatef(x, y, z);
	glRotatef(rotX, 1.0f, 0.0f, 0.0f);
...
//ofxVec3f:
void ofxLineBox(ofxVec3f position, float size){
	if(lineBoxList == 0) ofxCreateLineBoxList();
	glPushMatrix();
	glTranslatef(position.x, position.y, position.z);
	glScalef(size, size, size);
...
void ofxLineBox(ofxVec3f position, ofxVec3f size){
	if(lineBoxList == 0) ofxCreateLineBoxList();
	glPushMatrix();
	glTranslatef(position.x, position.y, position.z);
	glScalef(size.x, size.y, size.z);
...
void ofxLineBox(ofxVec3f position, ofxVec3f size, ofxVec3f rotation){
	if(lineBoxList == 0) ofxCreateLineBoxList();
	glPushMatrix();
	glTranslatef(position.x, position.y, position.z);
	glRotatef(rotation.x, 1.0f, 0.0f, 0.0f);
